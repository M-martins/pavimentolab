...
const PAVIMENTOLAB_VERSION = "v21.6-indexeddb-popup-calibracao-fixo-mobile";
...
async function calibrateSensors(){
  ...
  try{
    localStorage.setItem("pavimentolab_calibration_v21_6", JSON.stringify(calibration));
  }catch(err){
...
boot().catch(err=>{
  console.error(err);
  alert("Erro ao iniciar PavimentoLab v21.6: " + (err.message || err));
});
